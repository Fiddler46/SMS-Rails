...
ActiveRecord::Schema.define(version: 2021_10_07_114138) do
  ...
  create_table "developer_teams", force: :cascade do |t|
    t.bigint "team_id"
    t.bigint "developer_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["developer_id"], name: "index_developer_teams_on_developer_id"
    t.index ["team_id"], name: "index_developer_teams_on_team_id"
  end
